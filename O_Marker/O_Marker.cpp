...
/********************************************************************/
/*								    */
/*   Выдать координаты базовой точки                                */
/*								    */
/*   Return: число базовых точек                                    */

     int  RSS_Object_Marker::vGetBasePoint(RSS_Point *points)

{
           points->x   =this->x_base ;
           points->y   =this->y_base ;
           points->z   =this->z_base ;
           points->azim=this->a_azim ;
           points->elev=this->a_elev ;
           points->roll=this->a_roll ;
...
/*      Выдать координаты целевой точки, привязанной к объекту      */
     ...
     int  RSS_Object_Marker::vGetTarget(char *part, RSS_Point *target)

{
           target->x   =this->x_base ;
           target->y   =this->y_base ;
           target->z   =this->z_base ;
           target->azim=this->a_azim ;
           target->elev=this->a_elev ;
           target->roll=this->a_roll ;
