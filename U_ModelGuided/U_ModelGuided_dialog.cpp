...
/* 	     Обработчик сообщений диалогового окна HELP	             */
  ...
  INT_PTR CALLBACK  Unit_ModelGuided_Help_dialog(  HWND hDlg,     UINT Msg, 
                                                 WPARAM wParam, LPARAM lParam) 
{
  RSS_Module_ModelGuided  Module ;
...
/* 	     Обработчик сообщений диалогового окна PARS	             */
  ...
  INT_PTR CALLBACK  Unit_ModelGuided_Pars_dialog(  HWND hDlg,     UINT Msg, 
                                                 WPARAM wParam, LPARAM lParam) 
{
   static  RSS_Unit_ModelGuided *unit ;
                            int  elm ;         /* Идентификатор элемента диалога */
                            int  status ;
                           char  text[512] ;
                         double  mass ;
...
/*---------------------------------------------------- Инициализация */
    ...
    case WM_INITDIALOG: {
                           ...
                           unit=(RSS_Unit_ModelGuided *)lParam ;
/*- - - - - - - - - - - - - - - - - - - - -  Инициализация элементов */
