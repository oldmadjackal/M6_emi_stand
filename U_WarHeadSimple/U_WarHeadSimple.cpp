...
/*                            Список команд                         */
 ...
 { "pancakes","pc", "#PANCAKES - задать характеристики кассетной БЧ с выбросом последовательными кругами ('блинчики')",
                    " PANCAKES <Имя> <Суб-боеприпас> <Число суб-боеприпасов> <Шаг выброса> <Число кругов> <Радиус круга>\n"
