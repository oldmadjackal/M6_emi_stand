...
/*   1 - Второй и последующие участки добавляются исходя из         */
/*       следующих правил:                                          */
/*        * Отворот от направления предыдущего участка в диапазоне  */
/*          AZIM_N_MIN ... AZIM_N_MAX с длинной отрезка в           */
/*          диапазоне RANGE_N_MIN ... RANGE_N_MAX                   */
/*        * Конечная точка отрезка должна быть ближе к цели, чем    */
/*          конечная точка предыдущего этапа (она же - начальная    */
/*          точка для данного)                                      */
/*        * Если в процессе движения по участку происходит          */
/*          сближение с целью на дистанцию менее RANGE_DIRECT -     */
/*          после добавления участка переходим к этапу [2]          */
/*   2 - Движение непосредственно на цель                           */
/*                                                                  */
/*  Параметры программы:                                            */
/*    PROGRAM        - ZIGZAG                                       */
