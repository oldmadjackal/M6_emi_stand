...
/* 	     Обработчик сообщений диалогового окна HELP	             */
  ...
  INT_PTR CALLBACK  Unit_Program_Help_dialog(  HWND hDlg,     UINT Msg, 
...
#define  _IND_MAX  10
  ...
  INT_PTR CALLBACK  Unit_Program_Show_dialog(  HWND  hDlg,     UINT  Msg, 
                                             WPARAM  wParam, LPARAM  lParam) 
{
...
/*- - - - - - - - - - - - - - - - - - - - - - - -  Пропись заголовка */
              sprintf(title, "Программа управления: %s.%s",
